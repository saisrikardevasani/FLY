"""Books to Scrape scraper. Generated from prompt-v1.md. Not edited afterwards."""
...
def parse_book(html: str, url: str, source_page: str) -> dict:
...
def main() -> None:
    ...
    for url, source_page in targets:
        ...
        seen.add(url)
        try:
            raw = parse_book(get(url), url, source_page)
